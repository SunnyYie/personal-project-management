...
const ProjectTaskList = lazy(() => import('@/pages/tasks/projectTaskList/index'))
const ProjectTaskDetail = lazy(() => import('@/pages/tasks/projectTaskList/detail'))

export const task: AppRouteObject = {
  order: 3,
  path: 'task',
  element: (
  ...
  children: [
    ...
    },
    {
      ...
      meta: { label: taskObj.projectTaskList.name, key: '/task/projectTaskList/index' },
    },
    {
      path: 'projectTaskDetail',
      element: <ProjectTaskDetail />,
      meta: { label: taskObj.projectTaskList.detail.name, key: '/task/projectTaskList/detail/:id' },
    },
  ],
}
